...
public class ConfirmFire extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggle = new ActionBarDrawerToggle(ConfirmFire.this, drawerLayout, R.string.open, R.string.close);
